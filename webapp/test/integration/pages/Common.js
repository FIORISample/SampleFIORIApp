sap.ui.define([
	...
	return Opa5.extend("sdApp.SalesDataApp.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["sdApp/SalesDataApp/localService/mockserver"], function (mockserver) {
