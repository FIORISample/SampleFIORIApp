					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sales Details",
									"targetURL": "#SalesDetails-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"SalesDetails-display": {
								"semanticObject": "SalesDetails",
								"action": "display",
								"description": "Sales Header and Item Details",
								"title": "Sales Details",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sdApp.SalesDataApp",
									"url": sap.ui.require.toUrl("sdApp/SalesDataApp")
								}
							}
						}
					}
